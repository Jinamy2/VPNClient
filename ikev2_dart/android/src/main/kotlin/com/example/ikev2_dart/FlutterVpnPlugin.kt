...
class FlutterVpnPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        ...
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "ikev2_dart")
        channel.setMethodCallHandler(this)

        // Register event channel to handle state change.
        eventChannel = EventChannel(flutterPluginBinding.binaryMessenger, "ikev2_dart_states")
        eventChannel.setStreamHandler(VpnStateHandler)

        //Register itrafficMeasurer to handle traffic.
        trafficChannel = EventChannel(flutterPluginBinding.binaryMessenger, "ikev2_dart_traffic")
